...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.cooee.zenlauncher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.cooee.zenlauncher.permission.RECEIVE_LAUNCH_BROADCASTS";
